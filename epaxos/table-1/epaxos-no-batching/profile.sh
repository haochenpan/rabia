...
EPaxosFolder=/root/go/src/rabia/epaxos/table-1/epaxos-no-batching # where the epaxos' bin folder is located
LogFolder=/root/go/src/rabia/epaxos/table-1/epaxos-no-batching/logs
